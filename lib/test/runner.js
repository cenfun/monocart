...
module.exports = (config) => {
    ...
    const customReporter = Util.formatPath(path.resolve(Util.nmRoot, 'node_modules/playwright-report-grid'));
    config.reporter = [
        ['list'],
        ['json', {
            outputFile: '.temp/report-json/report.json'
        }],
        ['html', {
            open: 'never',
            outputFolder: '.temp/report-html'
        }],
        [customReporter, {
